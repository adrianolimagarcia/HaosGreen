...
<body>
    ...
    <div class="advanced-section">
      ...
      <div class="advanced-content">
        <div class="field">
          ...
          <input type="text" id="sandboxDir" placeholder="~/.haos-green/workspace">
        </div>
        <div class="field">
          <label>Database path</label>
          <input type="text" id="dbPath" placeholder="~/.haos-green/haos-green.db">
        </div>
        <div class="field">
          <label>Skills directory</label>
          <input type="text" id="skillsDir" placeholder="~/.haos-green/skills">
        </div>
        <div class="field">
          <label>Agents directory</label>
          <input type="text" id="agentsDir" placeholder="~/.haos-green/agents">
        </div>
        <div class="field">
          <label>Home directory</label>
          <input type="text" id="homeDir" placeholder="~/.haos-green">
        </div>
        <div class="field">
    ...
    <div class="advanced-section">
      ...
      <div class="advanced-content">
        ...
        <div class="field">
          ...
          <input type="text" id="langsmithProject" placeholder="haos-green" value="haos-green">
        </div>
  ...
  <div class="step" data-step="5">
    <h2>✅ Config saved!</h2>
    <p>Your HaosGreen configuration has been written. Start the bot with:</p>
    <pre>cargo run --bin haos-green</pre>
  </div>
</body>
</html>
```
...
async function loadExistingConfig() {
  ...
  document.getElementById('langsmithProject').value = data.langsmith_project || 'haos-green';
...
function buildToml() {
  ...
  if (lsk) {
    t += `[langsmith]\napi_key = "${esc(lsk)}"\n`;
    t += `project = "${esc(document.getElementById('langsmithProject').value || 'haos-green')}"\n\n`;
  }
...
if show_advanced {
    ...
    if ask("Configure LangSmith?", "n") {
        ...
        let ls_project = prompt("LangSmith project", "haos-green");
    }
